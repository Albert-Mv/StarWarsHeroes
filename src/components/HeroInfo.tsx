...
import { clearHeroData, setHeroData, updateHeroField } from '../redux/slices/hero';
...
const HeroInfo: FC = React.memo(() => {
  ...
  const isLocalDirty = useSelector<RootState, boolean>((state) => state.hero.isDirty);
  const dispatch = useDispatch();

  const storeHero = useMemo(() => heroes.find((item) => item.name == id), [heroes]);
